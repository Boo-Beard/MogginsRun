...
const webAppUrl = 'https://script.google.com/macros/s/AKfycbzOm-y7SPk8SIYU19MSO4zad_c2jjPkA9q1eCl-yHxDv2FtxfLUGKMhdcIVK8rGSwqy/exec';
...
$('.sound').click(function() {
    ...
    if ($this.hasClass('sound-on')) {
        ...
        $this.html('<i class="fa-solid fa-volume-xmark fa-beat-fade"></i>'); // Update to sound-off icon
        playSound = false;
    }
    // sound on
    else {
        $this.removeClass('sound-off').addClass('sound-on');
        $this.html('<i class="fa-solid fa-volume-high"></i>'); // Update to sound-on icon
        playSound = true;
    }
